document.addEventListener('DOMContentLoaded', function(evento) { // Este evento é acionado quando o DOM (Document Object Model) do HTML é completamente carregado
